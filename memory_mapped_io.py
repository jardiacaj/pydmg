...
class MemoryMappedIO:
    ...
    def generate_mapping(self):
        return {
            0xFF11: ("NR 11 Channel 1 Sound length/Wave pattern duty (R/W)",
                     read_NR11, write_NR11),
            0xFF12: ("NR 12 Channel 1 Volume Envelope (R/W)",
                     read_NR12, write_NR12),
            0xFF13: ("NR 13 Channel 1 Frequency lo (W)", None,
                     write_NR13),
            0xFF14: ("NR 14 Channel 1 Frequency hi (R/W)",
                     read_NR14, write_NR14),
            0xFF24: ("NR 50 Channel control / ON-OFF / Volume (R/W)",
                     read_NR50, write_NR50),
            0xFF25: ("NR 51 Selection of Sound output terminal (R/W)",
                     read_NR51, write_NR51),
            0xFF26: ("NR 52 Sound on/off",
                     read_NR52, write_NR52),
            0xFF40: ("LCDC LDC Control (R / W)",
                     read_LCDC, write_LCDC),
            0xFF42: ("SCY Scroll Y (R / W)",
                     lambda io: io.lcd.scroll_y, write_SCY),
            0xFF43: ("SCX Scroll X (R / W)",
                     lambda io: io.lcd.scroll_x, write_SCX),
            0xFF44: ("LCDC Y-Coordinate (current line)",
                     lambda io: io.lcd.current_line, write_LCDC_Y_Coord),
            0xFF47: ("BGP - BG Palette Data (R/W) - Non CGB Mode Only",
                     read_BGP, write_BGP),
            0xFF50: ("Disable boot ROM",
                     None, disable_boot_rom),
        }
